...
"""
    ...
    def _format_findings(self, findings: List[Dict[str, str]]) -> str:
        ...
        # Info last
        if info:
            output.append("### 🔵 Informational Notes\n")
    ...
    def _generate_executive_summary(
        ...
        # Status badge
        if critical_count > 0:
            summary_parts.append("**Status:** 🔴 CRITICAL ISSUES IDENTIFIED")
        elif warning_count > 0:
            summary_parts.append("**Status:** 🟡 ATTENTION REQUIRED")
        else:
            summary_parts.append("**Status:** ✅ NO MAJOR ISSUES")
...
"""
        ...
        if warnings:
            actions.append("### 🟡 Recommended Follow-up\n")
        ...
        actions.append("### 📋 General Recommendations\n")
